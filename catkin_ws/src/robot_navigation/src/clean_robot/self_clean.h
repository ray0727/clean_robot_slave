...
class Self_Clean{
	...
	public:
		...
		double diffx,diffy,rotatedegree;
	protected:
	...
	void set_tf(float diffx,float diffy,float rotatedegree){this->diffx=diffx; this->diffy=diffy; this->rotatedegree=rotatedegree;}
	Pointf tfmtos(Pointf m);
